...
activate' n cls extra chunk
    ...
    | "FosterFOL"        `elem` cls = exTemplate [("system", "fosterAndLaursenFOL"), ("options","render")]
    | "FosterFOL2019"    `elem` cls = exTemplate [("system", "fosterAndLaursenFOL2019"), ("options","render")]
    | "FosterFOLCore"    `elem` cls = exTemplate [("system", "fosterAndLaursenFOLCore"), ("options","render")]
    | "FosterFOLPlus2019"`elem` cls = exTemplate [("system", "fosterAndLaursenFOLPlus2019"), ("options","render")]
    | "FosterTFL"        `elem` cls = exTemplate [("system", "fosterAndLaursenTFL"), ("options","render")]
    | "FosterTFL2019"    `elem` cls = exTemplate [("system", "fosterAndLaursenTFL2019"), ("options","render")]
    | "FosterTFLCore"    `elem` cls = exTemplate [("system", "fosterAndLaursenTFLCore"), ("options","render")]
    | "FosterPropEq"     `elem` cls = exTemplate [("system", "fosterPropEq"), ("options","render")]
    | "FosterFOLEq"      `elem` cls = exTemplate [("system", "fosterFOLEq"), ("options","render")]
...
toPlayground n cls extra content
    ...
    | "FosterFOL"        `elem` cls = playTemplate [("system", "fosterAndLaursenFOL"), ("options","render")]
    | "FosterFOL2019"    `elem` cls = playTemplate [("system", "fosterAndLaursenFOL2019"), ("options","render")]
    | "FosterFOLCore"    `elem` cls = playTemplate [("system", "fosterAndLaursenFOLCore"), ("options","render")]
    | "FosterFOLPlus2019"`elem` cls = playTemplate [("system", "fosterAndLaursenFOLPlus2019"), ("options","render")]
    | "FosterTFL"        `elem` cls = playTemplate [("system", "fosterAndLaursenTFL"), ("options","render")]
    | "FosterTFL2019"    `elem` cls = playTemplate [("system", "fosterAndLaursenTFL2019"), ("options","render")]
    | "FosterTFLCore"    `elem` cls = playTemplate [("system", "fosterAndLaursenTFLCore"), ("options","render")]
    | "FosterPropEq"     `elem` cls = playTemplate [("system", "fosterPropEq"), ("options","render")]
    | "FosterFOLEq"      `elem` cls = playTemplate [("system", "fosterFOLEq"), ("options","render")]
