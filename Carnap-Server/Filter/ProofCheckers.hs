...
activate' n cls extra chunk
    ...
    | "FosterFOL"        `elem` cls = exTemplate [("system", "fosterAndLaursenFOL"), ("options","render fonts")]
    | "FosterFOL2019"    `elem` cls = exTemplate [("system", "fosterAndLaursenFOL2019"), ("options","render fonts")]
    | "FosterFOLCore"    `elem` cls = exTemplate [("system", "fosterAndLaursenFOLCore"), ("options","render fonts")]
    | "FosterFOLPlus2019"`elem` cls = exTemplate [("system", "fosterAndLaursenFOLPlus2019"), ("options","render fonts")]
    | "FosterTFL"        `elem` cls = exTemplate [("system", "fosterAndLaursenTFL"), ("options","render fonts")]
    | "FosterTFL2019"    `elem` cls = exTemplate [("system", "fosterAndLaursenTFL2019"), ("options","render fonts")]
    | "FosterTFLCore"    `elem` cls = exTemplate [("system", "fosterAndLaursenTFLCore"), ("options","render fonts")]
    | "FosterPropEq"     `elem` cls = exTemplate [("system", "fosterPropEq"), ("options","render fonts")]
    | "FosterFOLEq"      `elem` cls = exTemplate [("system", "fosterFOLEq"), ("options","render fonts")]
    ...
    | "RavenSLPlus"      `elem` cls = exTemplate [("system", "ravenTFL"), ("options","render")]
...
toPlayground n cls extra content
    ...
    | "FosterFOL"        `elem` cls = playTemplate [("system", "fosterAndLaursenFOL"), ("options","render fonts")]
    | "FosterFOL2019"    `elem` cls = playTemplate [("system", "fosterAndLaursenFOL2019"), ("options","render fonts")]
    | "FosterFOLCore"    `elem` cls = playTemplate [("system", "fosterAndLaursenFOLCore"), ("options","render fonts")]
    | "FosterFOLPlus2019"`elem` cls = playTemplate [("system", "fosterAndLaursenFOLPlus2019"), ("options","render fonts")]
    | "FosterTFL"        `elem` cls = playTemplate [("system", "fosterAndLaursenTFL"), ("options","render fonts")]
    | "FosterTFL2019"    `elem` cls = playTemplate [("system", "fosterAndLaursenTFL2019"), ("options","render fonts")]
    | "FosterTFLCore"    `elem` cls = playTemplate [("system", "fosterAndLaursenTFLCore"), ("options","render fonts")]
    | "FosterPropEq"     `elem` cls = playTemplate [("system", "fosterPropEq"), ("options","render fonts")]
    | "FosterFOLEq"      `elem` cls = playTemplate [("system", "fosterFOLEq"), ("options","render fonts")]
    ...
    | "RavenSLPlus"      `elem` cls = playTemplate [("system", "ravenTFL"), ("options","render")]
